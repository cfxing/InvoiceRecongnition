...
import train_crnn.config as config
import cv2
import torch
...
# recognize api
class PytorchOcr:
    def __init__(self, model_path = r'D:\Devsoft\PyCharm\PycharmProjects\InvoiceRecognition\train_crnn\crnn_models\CRNN-1010.pth'):
